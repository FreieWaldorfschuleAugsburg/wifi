...
class UniFiExceptionHandler extends BaseExceptionHandler implements ExceptionHandlerInterface
{
    ...
    {
        $this->render($exception, $statusCode, $this->viewPath . "error_unifi.php");
    }
}